...
+ (void)fireEvent:(NSString *)eventName data:(NSDictionary *)data withWebView:(UIView<BUWebView> *)webview completion:(void (^)(id result, NSError *error))completionHandler;
/**
 注册JSBridge别名
 @warning 会优先查找别名
 @param alias 新名
