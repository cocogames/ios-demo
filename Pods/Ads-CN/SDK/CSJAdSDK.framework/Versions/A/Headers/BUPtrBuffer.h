...
#ifndef BU_ALOG_COMM_PTRBUFFER_H_
#define BU_ALOG_COMM_PTRBUFFER_H_
...
class BUPtrBuffer {
  ...
  public:
    BUPtrBuffer(void* _ptr, size_t _len, size_t _maxlen);
    BUPtrBuffer(void* _ptr, size_t _len);
    BUPtrBuffer();
    ~BUPtrBuffer();
  ...
  private:
    BUPtrBuffer(const BUPtrBuffer& _rhs);
    BUPtrBuffer& operator = (const BUPtrBuffer& _rhs);
...
extern const BUPtrBuffer KBUNullPtrBuffer;
